...
var stateCache = {};
exports.onPreBootstrap = function (context, pluginConfig) { return __awaiter(_this, void 0, void 0, function () {
    var config, reporter, actions, client, api, graphqlSdl, graphqlSdlKey, typeMap, typeMapKey, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                config = __assign({}, defaultConfig, pluginConfig);
            ...
            case 2:
                ...
                return [4 /*yield*/, rewriteGraphQLSchema_1.rewriteGraphQLSchema(api, config)];
            case 3:
                graphqlSdl = _a.sent();
                ...
                typeMap = remoteGraphQLSchema_1.getTypeMapFromGraphQLSchema(api, pluginConfig);
...
exports.createResolvers = function (actions, pluginConfig) {
...
exports.sourceNodes = function (context, pluginConfig) { return __awaiter(_this, void 0, void 0, function () {
    var config, dataset, overlayDrafts, watchMode, actions, getNode, createNodeId, createContentDigest, reporter, createNode, createTypes, createParentChildLink, graphqlSdlKey, graphqlSdl, typeMapKey, typeMap, client, url, inputStream, processingOptions, draftDocs, publishedNodes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                config = __assign({}, defaultConfig, pluginConfig);
                dataset = config.dataset, overlayDrafts = config.overlayDrafts, watchMode = config.watchMode;
                actions = context.actions, getNode = context.getNode, createNodeId = context.createNodeId, createContentDigest = context.createContentDigest, reporter = context.reporter;
                createNode = actions.createNode, createTypes = actions.createTypes, createParentChildLink = actions.createParentChildLink;
                graphqlSdlKey = cache_1.getCacheKey(pluginConfig, cache_1.CACHE_KEYS.GRAPHQL_SDL);
                graphqlSdl = stateCache[graphqlSdlKey];
            ...
            case 1:
                ...
                return [4 /*yield*/, pump_1.pump([
                        ...
                        through.obj(function (doc, enc, cb) {
                            debug_1.default('Got document with ID %s', doc._id);
            ...
            case 2:
                ...
                if (draftDocs.length > 0) {
                    ...
                    draftDocs.forEach(function (draft) {
                        ...
                        if (published) {
                            publishedNodes.set(handleDrafts_1.unprefixId(draft._id), published);
                        }
                    });
                }
                if (watchMode) {
                    ...
                    client
                        .listen('*')
                        .pipe(operators_1.filter(function (event) { return overlayDrafts || !event.documentId.startsWith('drafts.'); }), operators_1.filter(function (event) { return !event.documentId.startsWith('_.'); }))
...
exports.onPreExtractQueries = function (context, pluginConfig) { return __awaiter(_this, void 0, void 0, function () {
...
var resolveReferencesConfig = new graphql_1.GraphQLInputObjectType({
...
exports.setFieldsOnGraphQLNodeType = function (context, pluginConfig) { return __awaiter(_this, void 0, void 0, function () {
    var type, typeMapKey, typeMap, schemaType, fields;
    return __generator(this, function (_a) {
        type = context.type;
        typeMapKey = cache_1.getCacheKey(pluginConfig, cache_1.CACHE_KEYS.TYPE_MAP);
        typeMap = (stateCache[typeMapKey] || remoteGraphQLSchema_1.defaultTypeMap);
        schemaType = typeMap.objects[type.name];
        fields = {};
        if (type.name === 'SanityImageAsset') {
            fields = __assign({}, fields, extendImageNode_1.extendImageNode(context, pluginConfig));
        }
        if (!schemaType) {
            debug_1.default('[%s] Not in type map', type.name);
            return [2 /*return*/, fields];
        }
        return [2 /*return*/, Object.keys(schemaType.fields).reduce(function (acc, fieldName) {
                var field = schemaType.fields[fieldName];
                var aliasFor = field.aliasFor;
                if (field.namedType.name.value === 'JSON' && aliasFor) {
                    var aliasName_1 = '_' + lodash_1.camelCase("raw " + field.aliasFor);
                    acc[aliasName_1] = {
                        ...
                        resolve: function (obj, args) {
                            ...
                            var value = obj[raw] || obj[fieldName] || obj[aliasFor];
                ...
                acc[aliasName] = {
                    ...
                    resolve: function (obj, args) {
                        var raw = "_" + lodash_1.camelCase("raw_data_" + (field.aliasFor || fieldName));
                        var value = obj[raw] || obj[aliasName] || obj[fieldName];
                        return args.resolveReferences
                            ? resolveReferences(value, 0, args.resolveReferences.maxDepth, context, pluginConfig)
                            : value;
                    },
...
function resolveReferences(obj, depth, maxDepth, context, pluginConfig) {
    var createNodeId = context.createNodeId, getNode = context.getNode;
    var overlayDrafts = pluginConfig.overlayDrafts;
    if (Array.isArray(obj)) {
        return depth <= maxDepth
            ? obj.map(function (item) { return resolveReferences(item, depth + 1, maxDepth, context, pluginConfig); })
            : obj;
    }
    ...
    if (typeof obj._ref === 'string') {
        var id = obj._ref;
        var node = getNode(createNodeId(overlayDrafts ? normalize_1.unprefixDraftId(id) : id));
    ...
    return Object.keys(obj).reduce(function (acc, key) {
        ...
        var targetKey = isGatsbyRef && depth <= maxDepth ? key.slice(0, -7) : key;
        var value = obj[key];
