...
function processDocument(doc, options) {
    ...
    var node = __assign({}, withRefs, rawAliases, { id: createNodeId(overlayDrafts ? unprefixDraftId(doc._id) : doc._id), parent: null, children: [], internal: {
...
function rewriteNodeReferences(doc, options) {
    ...
    refs.forEach(function (match) {
        lodash_1.set(newDoc, match.path, createNodeId(match.value));
    });
    return newDoc;
}
